...
class Chapter12(PhysicsChapter):
    ...
    def __init__(self) -> None:
        ...
        self.equations: List[Equation] = [
            Equation(
                name="First Equilibrium Condition", formula="∑Fₖ = 0", variables={}
            ),
            Equation(
                name="Second Equilibrium Condition", formula="∑τₖ = 0", variables={}
            ),
            Equation(
    ...
    class Calculate:
        ...
        def young_modulus(
            ...
            if (
                init_length is not None
                and init_length <= 0.0
                or cross_section is not None
